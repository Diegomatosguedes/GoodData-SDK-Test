...
export class MetricsComponent {
  ...
  constructor(
    ...
    this.po_lo_text = { value: this._translateService.CNST_TRANSLATIONS['MESSAGES.LOADING_METRICS'] };
    this.setIFrameURL(CNST_GOODDATA_HOST + '/metrics/#/' + this._gooddataService._CURRENT_WORKSPACE.workspaceId);
