...
export class SQLParameterServer {
  ...
  public toObject(data: SQLParameterServer): SQLParameterServer {
    ...
    this.versionName = this.version.getVersion();
    this.sql = data.sql;
    this.commaSeparatedValues = data.commaSeparatedValues;
  ...
  public toClient(): SQLParameterClient {
    ...
    param.version = this.version
    param.TOTVS = true;
    param.commaSeparatedValues = this.commaSeparatedValues;
  ...
  constructor() {
    ...
    this.versionName = this.version.getVersion();
    this.sql = false;
    this.commaSeparatedValues = false;
  }
}
