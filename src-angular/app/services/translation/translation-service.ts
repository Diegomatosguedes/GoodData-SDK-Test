  ...
  */
  ...
  public updateStandardTranslations(): Observable<boolean> {
    return this.getTranslations([
      ...
      new TranslationInput('BUTTONS.DUPLICATE', []),
      ...
      new TranslationInput('QUERIES.DELETE_QUERIES', []),
      new TranslationInput('QUERIES.DELETE_QUERIES_TITLE', []),
      new TranslationInput('QUERIES.DELETE_QUERIES_DESCRIPTION', []),
      ...
      new TranslationInput('QUERIES.MESSAGES.DELETE_MULTIPLE', []),
      ...
      new TranslationInput('SCHEDULES.MESSAGES.DUPLICATE', []),
      new TranslationInput('SCHEDULES.MESSAGES.DUPLICATE_OK', []),
      new TranslationInput('SCHEDULES.MESSAGES.DUPLICATE_ERROR', []),
      ...
      new TranslationInput('WORKSPACES.MESSAGES.DUPLICATE', []),
      new TranslationInput('WORKSPACES.MESSAGES.DUPLICATE_OK', []),
      new TranslationInput('WORKSPACES.MESSAGES.DUPLICATE_ERROR', [])
    ]).pipe(map((translations: any) => {
