export const CNST_TRANSLATIONS_ES_ES: any = {
  ...
  WORKSPACES: {
    ...
    MESSAGES: {
      ...
      DUPLICATE: 'Espere por favor...',
      DUPLICATE_OK: 'Ambiente duplicado con éxito.',
      DUPLICATE_ERROR: 'Error - No fue posible duplicar el ambiente. Por favor intenta otra vez.'
    },
    SECTIONS: {
  ...
  SCHEDULES: {
    ...
    MESSAGES: {
      ...
      DUPLICATE: 'Espere por favor...',
      DUPLICATE_OK: 'Horario duplicado con éxito.',
      DUPLICATE_ERROR: 'Error - No fue posible duplicar el horario. Por favor intenta otra vez.'
    },
    TOOLTIPS: {
  ...
  QUERIES: {
    ...
    DELETE_QUERIES: 'Borrar consultas',
    DELETE_QUERIES_TITLE: 'Borrar varias consultas por modulo',
    DELETE_QUERIES_DESCRIPTION: 'Selecciona el modulo abajo para borrar todas as consultas del mismo.',
    ...
    MESSAGES: {
      ...
      DELETE_MULTIPLE: 'Borrando consultas...',
