export const CNST_TRANSLATIONS_EN_US: any = {
  ELECTRON: {
    ...
    UPDATE_READY_DESCRIPTION: 'Would you like to install the updates?',
  ...
  WORKSPACES: {
    ...
    MESSAGES: {
      ...
      DUPLICATE_OK: 'Workspace successfully duplicated.',
      DUPLICATE_ERROR: 'Error - Unable to duplicate workspace. Please try again.'
    },
    TABLE: {
      ERP: 'ERP',
      PRODUCT: 'Module',
  ...
  SCHEDULES: {
    ...
    MESSAGES: {
      ...
      DUPLICATE: 'Please wait...',
      DUPLICATE_OK: 'Schedule successfully duplicated.',
      DUPLICATE_ERROR: 'Error - Unable to duplicate schedule. Please try again.'
     },
    TOOLTIPS: {
  ...
  QUERIES: {
    ...
    DELETE_QUERIES_TITLE: 'Delete multiple queries by module',
    DELETE_QUERIES_DESCRIPTION: 'Please select which module to delete all queries.',
    NEW_QUERY: 'New query',
    ...
    MESSAGES: {
      ...
      DELETE_MULTIPLE: 'Removing queries...',
