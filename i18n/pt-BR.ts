export const CNST_TRANSLATIONS_PT_BR: any = {
  ...
  BUTTONS: {
    ...
    YES: 'Sim',
    NO: 'Não',
    UPDATE_NOW: 'Agora (Irá encerrar o Agent)',
    UPDATE_LATER: 'Mais tarde (Quando encerrar)'
  },
  SOURCES: {
    LOCALLY: 'Local',
  ...
  WORKSPACES: {
    ...
    MESSAGES: {
      ...
      DUPLICATE: 'Por favor aguarde...',
      DUPLICATE_OK: 'Ambiente duplicado com sucesso.',
      DUPLICATE_ERROR: 'Erro - Não foi possível duplicar o ambiente. Por favor tente novamente.'
    },
    TABLE: {
      ERP: 'ERP',
      PRODUCT: 'Módulo',
  ...
  SCHEDULES: {
    ...
    MESSAGES: {
      ...
      DUPLICATE: 'Por favor aguarde...',
      DUPLICATE_OK: 'Agendamento duplicado com sucesso.',
      DUPLICATE_ERROR: 'Erro - Não foi possível duplicar o agendamento. Por favor tente novamente.'
    },
    TOOLTIPS: {
  ...
  QUERIES: {
    ...
    DELETE_QUERIES: 'Apagar consultas',
    DELETE_QUERIES_TITLE: 'Apagar múltiplas consultas por módulo',
    DELETE_QUERIES_DESCRIPTION: 'Selecione o módulo abaixo para apagar todas as consultas do mesmo.',
    ...
    MESSAGES: {
      ...
      DELETE_MULTIPLE: 'Apagando consultas...',
